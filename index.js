...
reviews.push({name: "Bill", rating: 4.5, feedback: "great food"});
console.log(reviews);
...
function getLastReview(array) {
  return array[array.length-1].toString(`${array[array.length-1].name} gave the restaurant a ${array[array.length-1].rating} star review, and their feedback was: ${array[array.length-1].feedback}`); 
} 
